...
const regions = [
  { name: "Москва", x: 24, y: 48 },
  { name: "Санкт-Петербург", x: 18, y: 38 },
  { name: "Краснодар", x: 22, y: 60 },
  { name: "Екатеринбург", x: 38, y: 45 },
  { name: "Новосибирск", x: 50, y: 48 },
  { name: "Владивосток", x: 88, y: 55 },
  { name: "Казань", x: 30, y: 46 },
  { name: "Нижний Новгород", x: 26, y: 46 },
  { name: "Самара", x: 31, y: 50 },
  { name: "Ростов-на-Дону", x: 23, y: 56 },
  { name: "Красноярск", x: 58, y: 45 },
  { name: "Тюмень", x: 41, y: 44 },
  { name: "Омск", x: 45, y: 47 },
  { name: "Челябинск", x: 38, y: 48 },
  { name: "Уфа", x: 35, y: 48 },
  { name: "Волгоград", x: 27, y: 54 },
  { name: "Пермь", x: 35, y: 43 },
  { name: "Иркутск", x: 64, y: 50 },
  { name: "Хабаровск", x: 84, y: 52 },
  { name: "Якутск", x: 76, y: 38 },
];
