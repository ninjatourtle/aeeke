  ...
  return (
    <Layout>
      <SEO
        ...
        description="Свяжитесь с нами для заказа нефтепродуктов. Адрес: Санкт-Петербург, пер. Зеленков, д. 7а. ☎ +7 (812) 218-03-00, info@aoec.ru"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <a href="tel:+78122180300" className="text-2xl font-bold text-foreground hover:text-primary transition-colors">
                  +7 (812) 218-03-00
                </a>
              </div>
            </div>
