...
const faq = [
  ...
  },
  {
    ...
    answer: "Заявку можно оформить через форму на сайте, по телефону +7 (812) 720-97-67 или по email info@aoec.ru. Мы свяжемся с вами в течение 1 часа в рабочее время.",
  },
  {
