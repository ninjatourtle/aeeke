...
const Privacy = () => {
  return (
    <Layout>
      <SEO
        title="Политика конфиденциальности — АО «ЭК»"
        description="Политика обработки и защиты персональных данных пользователей сайта АО «ЭК»."
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <section className="p-6 rounded-xl bg-card/80 border border-border">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  АО «ЭК» (далее — Компания) персональных данных пользователей 
